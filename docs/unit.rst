...
.. py:class:: pybrood.Unit
    ...
    .. py:method:: canUseTech(tech: TechType, target: Tuple[int, int], checkCanTargetUnit: bool=True, checkTargetsType: bool=True, checkCanIssueCommandType: bool=True, checkCommandibility: bool=True) -> bool
